...
namespace MySourceConsumer.Unions
{
    ...
    [UnionOperator(Op.Addition, Op.Subtraction, Op.Multiplication, Op.Division)]
    [UnionOperator(Op.LogicalAnd, Op.LogicalOr, Op.LogicalExclusiveOr)]
    [UnionOperator(Op.LessAndGreaterThan, Op.LessAndGreaterThanOrEqual)]
