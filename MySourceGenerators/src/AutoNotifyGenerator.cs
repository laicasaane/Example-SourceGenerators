...
";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            INamedTypeSymbol attributeSymbol = context.Compilation.GetTypeByMetadataName("MyLibrary.AutoNotifyAttribute");
            ...
            public void OnVisitSyntaxNode(GeneratorSyntaxContext context)
            {
                    ...
                    && fieldDeclarationSyntax.AttributeLists.Count > 0)
                {
                    foreach (VariableDeclaratorSyntax variable in fieldDeclarationSyntax.Declaration.Variables)
                    {
                        ...
                        if (fieldSymbol.GetAttributes().Any(ad => ad.AttributeClass.ToDisplayString() == "MyLibrary.AutoNotifyAttribute"))
                        {
